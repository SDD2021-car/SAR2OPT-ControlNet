...
from controlnet.validation import log_validation_pipeline_unclip
...
from controlnet.dataset import collate_fn_embed, ControlNetUnCLIPDataset
...
def main(cfg):
    ...
    noise_scheduler = DDPMScheduler.from_pretrained(cfg.pretrained_model_name_or_path+"/scheduler")
    ...
    train_dataset = ControlNetUnCLIPDataset(cfg, tokenizer, feature_extractor)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="./ControlNet_Pretrained_SEN12_season1.yaml")
    parser.add_argument(
        '--options',
        nargs='+',
